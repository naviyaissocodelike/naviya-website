...
const ESSAYS = [
  { date: '2026 · 06', tag: 'AI',           title: 'AI for good at scale is a distribution problem', blurb: "After watching a dozen pilots die: most 'AI for good' fails not at the model but at the last-mile handoff. Where the real lever is, and what one working version looks like.", href: '/ai-for-good', onSite: true },
  { date: '2026 · 06', tag: 'Crypto',       title: 'Stablecoins are the final rail, and it closes soon', blurb: 'Tala moves money in eight countries where SWIFT never landed. Stablecoin rails are the first infrastructure built for the customer we always skipped. The window to claim the position is about 18 months wide.', href: '/crypto-frontier', onSite: true },
  { date: '2026 · 06', tag: 'AI',           title: 'A field playbook for shipping agents to last-mile customers', blurb: 'The seven decisions that actually matter, drawn from two agents: Lucy in production at Tala, Luna built in a hackathon and heading to market. Constraints first. RAG as the floor. Habits, not dashboards.', href: '/agent-playbook', onSite: true },
  { date: '2026 · 06', tag: 'Personal',     title: 'Living aquatic',                               blurb: 'Scuba-certified in Honduras. The first time the surface closed above me, and the five things I came back with.', href: '/living-aquatic', onSite: true },
  ...
  { date: '2026 · 06', tag: 'AI',           title: 'AI diffusion in EM is best done with fintechs', blurb: 'Three reasons model labs will not be the ones who get agentic AI to the next billion. The partnership-first fintechs already have the trust, the distribution, and the customer. The thesis in plain English.', href: '/ai-diffusion', onSite: true },
  { date: '2026 · 05', tag: 'AI',           title: 'Shipping the first AI loan officer for Kenya', blurb: "Three versions, ten months at Tala, real money attached. What held up in the field, what didn't, and the onboarding redesign that moved retention 30% with N=5,000.", href: '/lucy', onSite: true },
  { date: '2026 · 05', tag: 'Money',        title: 'Micro signals, macro insights',                blurb: "Fintech customer data is the cleanest, most granular picture of an emerging-market economy that has ever existed. What it could power as a macro intelligence layer, and why now.", href: '/data-opportunity', onSite: true }
]
